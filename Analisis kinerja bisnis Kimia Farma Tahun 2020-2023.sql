CREATE TABLE rakamin-kf-analytics-423212.kimia_farma.kf_analisa AS
SELECT 
f.transaction_id,
f.date, 
f.branch_id, 
...
FROM 
  rakamin-kf-analytics-423212.kimia_farma.kf_final_transaction as f
LEFT JOIN rakamin-kf-analytics-423212.kimia_farma.kf_kantor_cabang as k
  on f.branch_id = k.branch_id
LEFT JOIN rakamin-kf-analytics-423212.kimia_farma.kf_product as p
